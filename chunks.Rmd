...
RMM_2019 <- unidos_2019 %>% 
  mutate(RMM_suma_19 = suma_quinquenio.x/suma_quinquenio.y*100000) %>% 
  mutate(RMM_mean_19 = mean.x/mean.y*100000)

RMM_2020 <- unidos_2020%>% 
  mutate(RMM_suma_20 = suma_quinquenio.x/suma_quinquenio.y*100000) %>% 
...
####base nacidos vivos y base proyecciones poblacionales indec
####Indicador construido para 2019 y 2020

#primero se calcula el número de nacidos vivos pra cada grupo etario de madres
...
```
#Se calculan las proyecciones poblacionales de madres (considerando sexo=femenino) para cada grupo etario
...
proyecciones_2020_25a29 <- base_proyecciones_fem_2020 %>%
  select(CodProv, X25.29)
```
#Se calculan las tasas dividiendo el número de nacimientos para cada rango etario por las proyecciones poblacionales de ese rango etario, por factor de expansión 10.000
...
#Análisis descriptivo de mortalidad por causas externas indeterminadas
...
```
#Hacemos un descriptivo de causas externas de mortalidad en niños y adolescentes
